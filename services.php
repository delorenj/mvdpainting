...
$paint_tiles = getBgTileImages("comps/paint");
$paper_tiles = getBgTileImages("comps/wallpaper");
$carpentry_tiles = getBgTileImages("comps/carpentry");
$misc_tiles = getBgTileImages("comps/misc");
